 ...
 * @LastEditors: qiaozp
 * @Description: 角色管理
 * @Date: 2019-03-12 09:44:26
 * @LastEditTime: 2019-04-18 19:38:51
 -->
<template>
	<div class="app-container">
		...
		<div class="filter-container">
			<el-form :inline="true" :model="listQuery" class="demo-form-inline">
				...
				<el-button class="filter-item green-btn" v-if="permBtn.role_add" type="primary" icon="iconfont iconxinzeng"  @click="handleCreate">
					新增
				</el-button>
			</el-form>
		</div>
				...
				<template slot-scope="scope">
					<el-dropdown  class="own-btn blue-btn" trigger="click">
						...
						<el-dropdown-menu slot="dropdown">
							...
							<el-dropdown-item v-if="permBtn.role_modify" @click.native="handleEdit(scope.$index, scope.row)">修改</el-dropdown-item>
							<el-dropdown-item v-if="permBtn.role_delete" @click.native="handleDelete(scope.$index, scope.row)">删除</el-dropdown-item>
						</el-dropdown-menu>
					</el-dropdown>
				</template>
			</el-table-column>
		...
		<!-- 新增弹窗 -->
		<el-dialog title="新增" :visible.sync="addDialogFormVisible" top="10%" width="500px" lock-scroll :close-on-click-modal="false"
	...
	export default {
		...
		methods: {
			...
			handleDelete(index, row) {
				...
				//确定删除
				this.$confirm('是否删除< '+ row.roleName +' >角色！', '删除', {
