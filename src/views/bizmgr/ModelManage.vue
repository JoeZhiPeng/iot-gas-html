 ...
 * @LastEditTime: 2019-04-25 16:59:25
 -->
<template>
		...
		<div class="filter-container">
			<el-form :inline="true" :model="listQuery" class="demo-form-inline">
				<el-form-item label="厂家名称">
					<el-select v-model="listQuery.factoryId" clearable filterable placeholder="请选择">
	...
	<!-- 表格 -->
		...
		<el-dialog title="新增" :visible.sync="addFormVisible" top="10%" width="400px" lock-scroll class="dialog"
			...
			<el-form class="small-space" ref="addDialogForm" :rules="rules" :model="addForm" label-position="left" label-width="120px" element-loading-text="拼命加载中">
				<el-form-item label="厂家：" prop="factoryId" class="dialog-sel">
				...
				<el-form-item label="型号：" prop="modelName" class="model">
					<el-input v-model="addForm.modelName" placeholder="请输入" clearable></el-input>
				</el-form-item>
		...
		<el-dialog title="修改" :visible.sync="editFormVisible"  @close="$refs.editDialogForm.resetFields()" top="10%" width="400px" lock-scroll class="dialog"
			...
			<el-form class="small-space" ref="editDialogForm" :rules="rules" :model="editForm" label-position="left" label-width="120px" element-loading-text="拼命加载中">	
				...
				<el-form-item label="型号：" prop="modelName" class="model">
					<el-input v-model="editForm.modelName" placeholder="请输入" clearable></el-input>
				</el-form-item>
				<el-form-item class="formButton">
	...
	export default {
		...
		methods: {
			...
			getList(isBackHome = false) {
				...
				//调用接口
		        vm.$instance.post("/proxy/bizmgr/model/findModelList", vm.listQuery).then(res =>{
